...
pub struct XrProjection {
    ...
    pub near: f32,
    /// Finite far distance used for CPU frustum and clustered-light culling.
    /// The render projection itself remains infinite reverse-Z.
    pub culling_far: f32,
}
...
mod tests {
    ...
    #[test]
    fn test_infinite_projection_uses_explicit_culling_far() {
        let near = 0.1;
        let culling_far = 1000.0;
        let fov = super::Fov {
            angle_left: -PI * 0.25,
            angle_right: PI * 0.25,
            angle_down: -PI * 0.25,
        ...
        assert_eq!(projection.far(), culling_far);
    }

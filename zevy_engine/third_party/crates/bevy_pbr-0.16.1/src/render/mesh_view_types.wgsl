...
struct ClusterOffsetsAndCounts {
    // [0..2) retain Bevy's offset/count ABI. Zevy uses [2] for four
    // preselected PointLight IDs and [3] for their f32 estimator weights
    // bitcast to u32. This avoids adding another per-view bind group entry.
    data: array<array<vec4<u32>, 4>>,
};
#else
struct ClusterableObjects {
